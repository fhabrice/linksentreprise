...
</style></head><body><main class="card"><h1>Installation sécurisée</h1><p>Configuration initiale de la plateforme LINKSTECH. Cette étape est privée.</p>
<?php if ($alreadyInstalled): ?><script>window.location.replace('/admin/');</script><p class="ok"><strong>La plateforme est déjà installée.</strong> Redirection vers l’espace administrateur…</p><?php elseif ($success): ?><div class="ok"><strong>Installation terminée.</strong><p>La plateforme est prête. Vous pouvez maintenant vous connecter avec votre code d’accès.</p><a class="button" href="/admin/">Ouvrir l’espace administrateur</a></div>
