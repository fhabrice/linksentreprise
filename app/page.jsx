...
const iconNames = {
  ...
  network: Icons.Network, handshake: Icons.Handshake, quote: Icons.Quote, 'message-circle': Icons.MessageCircle,
  send: Icons.Send
};
...
export default function Home() {
  ...
  <nav className="nav" id="navbar">
    <div className="container nav-inner">
      <a className="brand" href="#accueil" aria-label="Linkstech - Accueil"><span className="brand-mark"></span><span className="brand-text">LINKSTECH<small>Build · Code · Impact</small></span></a>
      <div className={`nav-links ${menuOpen ? 'open' : ''}`} id="navLinks" onClick={() => setMenuOpen(false)}><a href="#accueil">Accueil</a><a href="#apropos">À propos</a><a href="#services">Expertises</a><a href="#projets">Projets</a><a href="#contact" className="btn">Être mis en relation <Icon name="arrow-up-right" size={16} /></a></div>
  ...
  <main>
    <section className="hero" id="accueil">
      ...
      <div className="container"><div className="hero-content"><div className="hero-tag"><i></i> Construction · Technologie · Mise en relation</div><h1>Nous connectons<br />les services aux clients,<br /><span>les marchés aux entreprises.</span></h1><p>Basée en RDC, au Kenya et au Canada, Linkstech développe des solutions de construction et de technologie et facilite les connexions commerciales à l’échelle internationale.</p><div className="hero-connect"><Icon name="handshake" size={25} /><span><strong>Entreprise ou particulier ?</strong> Contactez-nous pour trouver le service, le client, le partenaire ou le marché qu’il vous faut.</span></div><div className="hero-actions"><a className="btn btn-primary" href="#contact">Être mis en relation <Icon name="arrow-right" size={18} /></a><a className="btn btn-outline" href="#projets">Découvrir nos réalisations</a></div></div></div>
      <div className="hero-foot"><div className="hero-stat"><strong>03</strong><small>Pôles d'expertise</small></div><div className="hero-stat"><strong>06+</strong><small>Solutions réalisées</small></div><div className="hero-stat"><strong>Global</strong><small>Notre ambition</small></div></div>
    </section>
