...
const iconNames = {
  ...
  network: Icons.Network, handshake: Icons.Handshake, 'hand-coins': Icons.HandCoins, 'bar-chart-3': Icons.BarChart3, 'graduation-cap': Icons.GraduationCap, quote: Icons.Quote, 'message-circle': Icons.MessageCircle,
  send: Icons.Send
};
...
export default function Home() {
  ...
  <nav className="nav" id="navbar">
    <div className="container nav-inner">
      ...
      <div className={`nav-links ${menuOpen ? 'open' : ''}`} id="navLinks" onClick={() => setMenuOpen(false)}><a href="#accueil">Accueil</a><a href="#apropos">À propos</a><a href="#services">Expertises</a><a href="#projets">Projets</a><a href="/opportunities.php">Opportunités</a><a href="#contact" className="btn">Être mis en relation <Icon name="arrow-up-right" size={16} /></a></div>
