...
const iconNames = {
  ...
  send: Icons.Send, shield: Icons.ShieldCheck, sun: Icons.Sun, zap: Icons.Zap, leaf: Icons.Leaf, building: Icons.Building2, users: Icons.Users
};
...
export default function Home() {
  ...
  <nav className="nav" id="navbar">
    <div className="container nav-inner">
      ...
      <div className={`nav-links ${menuOpen ? 'open' : ''}`} id="navLinks" onClick={() => setMenuOpen(false)}><a href="#accueil">Accueil</a><a href="#apropos">À propos</a><a href="#services">Expertises</a><a href="#energies">Énergie</a><a href="#projets">Projets</a><a href="#partenariats">Partenariats</a><a href="/opportunities.php">Opportunités</a><a href="/blog.php">Blog</a><a href="/admin/" className="nav-admin">Admin</a><a href="#contact" className="btn">Contact <Icon name="arrow-up-right" size={16} /></a></div>
  ...
  <main>
    ...
    <section className="intro" id="apropos"><div className="container intro-grid">
      <div className="intro-media reveal"><img loading="lazy" decoding="async" src="/assets/images/optimized/maison-rdc.webp" alt="Architecture moderne et expertise Linkstech" /><div className="intro-badge"><strong>360°</strong><span>Une vision intégrée, du plan à la solution finale.</span></div></div>
    ...
    <section className="services" id="services"><div className="container">
      ...
      <div className="service-grid reveal">
        ...
        <article className="service service-energy"><div className="service-icon"><Icon name="sun" /></div><span className="service-num">10 / ÉNERGIE RENOUVELABLE</span><h3>Énergies renouvelables</h3><p>Étude, conception et déploiement de solutions solaires, de stockage, d’éclairage intelligent et d’efficacité énergétique pour des chantiers, bureaux, institutions et communautés plus durables.</p><div className="connection-paths"><span><strong>Solaire</strong><Icon name="arrow-right" size={18} /><strong>Stockage</strong></span><span><strong>Énergie propre</strong><Icon name="arrow-right" size={18} /><strong>Projets durables</strong></span></div></article>
      </div>
    </div></section>

    <section className="energy" id="energies"><div className="container energy-grid">
      <div className="energy-media reveal"><img loading="lazy" decoding="async" src="/assets/images/optimized/energy-renewable.svg" alt="Énergies renouvelables : panneaux solaires et solutions propres développées par Linkstech" /><div className="energy-badge"><Icon name="zap" size={26} /><strong>Énergie propre</strong><span>Solaire · Stockage · Efficacité</span></div></div>
      <div className="energy-content reveal"><div className="eyebrow">Énergies renouvelables</div><h2 className="section-title">Une énergie propre,<br />au service de vos projets.</h2><p className="section-copy">Linkstech accompagne les entreprises, les institutions et les communautés dans le déploiement de solutions énergétiques durables : énergie solaire, stockage, éclairage intelligent et optimisation de la consommation.</p><div className="energy-points"><span><Icon name="sun" /><strong>Études solaires</strong><small>Dimensionnement, plans, chiffrage et faisabilité.</small></span><span><Icon name="leaf" /><strong>Solutions durables</strong><small>Éclairage public, sites isolés et infrastructures vertes.</small></span><span><Icon name="zap" /><strong>Intégration énergétique</strong><small>Solarisation des chantiers, bureaux et projets.</small></span><span><Icon name="building" /><strong>Bâtiments performants</strong><small>Conception et suivi d’unités économes en énergie.</small></span></div><div className="energy-cta"><a className="btn btn-primary" href="#contact">Parler de votre projet énergétique <Icon name="arrow-right" size={18} /></a></div></div>
    </div></section>
    ...
    <section className="projects" id="projets"><div className="container">
      ...
      <div className="project-grid">
        <article className={`project-card featured reveal ${filter !== "all" && filter !== "digital" ? "hidden" : ""}`} data-category="digital"><div className="project-image"><img loading="lazy" decoding="async" src="/assets/images/optimized/lito-finance.svg" alt="Tableau de bord de solution financière" /><span className="project-type">Fintech</span></div><div className="project-body"><h3>LITO Finance</h3><p>Conception d'une solution numérique orientée finance et gestion.</p></div></article>
        <article className={`project-card reveal ${filter !== "all" && filter !== "digital" ? "hidden" : ""}`} data-category="digital"><div className="project-image"><img loading="lazy" decoding="async" src="/assets/images/optimized/immobilier.svg" alt="Projet de plateforme immobilière" /><span className="project-type">Immobilier</span></div><div className="project-body"><h3>Youpend ImmoSelect</h3><p>Une expérience digitale dédiée à la recherche et la valorisation immobilière.</p></div></article>
        <article className={`project-card reveal ${filter !== "all" && filter !== "digital" ? "hidden" : ""}`} data-category="digital"><div className="project-image"><img loading="lazy" decoding="async" src="/assets/images/optimized/urbanova.svg" alt="Architecture urbaine Urbanova" /><span className="project-type">Proptech</span></div><div className="project-body"><h3>Urbanova</h3><p>Une solution moderne au service de la ville et de ses acteurs.</p></div></article>
        <article className={`project-card reveal ${filter !== "all" && filter !== "digital" ? "hidden" : ""}`} data-category="digital"><div className="project-image"><img loading="lazy" decoding="async" src="/assets/images/optimized/smart-event.svg" alt="Événement professionnel" /><span className="project-type">Événementiel</span></div><div className="project-body"><h3>Smart Event Kivu</h3><p>Plateforme intelligente pour simplifier l'organisation événementielle.</p></div></article>
        <article className={`project-card reveal ${filter !== "all" && filter !== "digital" ? "hidden" : ""}`} data-category="digital"><div className="project-image"><img loading="lazy" decoding="async" src="/assets/images/optimized/fieldlink.svg" alt="Outil numérique utilisé sur le terrain" /><span className="project-type">Field Tech</span></div><div className="project-body"><h3>FieldLink</h3><p>Des outils numériques qui connectent les équipes et les réalités du terrain.</p></div></article>
        <article className={`project-card featured reveal ${filter !== "all" && filter !== "construction" ? "hidden" : ""}`} data-category="construction"><div className="project-image"><img loading="lazy" decoding="async" src="/assets/images/optimized/construction-rdc.webp" alt="Équipe d'ingénieurs sur un chantier de construction en RDC" /><span className="project-type">Chantier · Goma</span></div><div className="project-body"><h3>Construction & suivi de chantier en RDC</h3><p>Étude, coordination et accompagnement de projets de construction adaptés aux matériaux, au terrain et aux réalités locales.</p></div></article>
        <article className={`project-card reveal ${filter !== "all" && filter !== "construction" ? "hidden" : ""}`} data-category="construction"><div className="project-image"><img loading="lazy" decoding="async" src="/assets/images/optimized/maison-rdc.webp" alt="Maison contemporaine adaptée au contexte de Goma en RDC" /><span className="project-type">Habitat · RDC</span></div><div className="project-body"><h3>Projets résidentiels à Goma</h3><p>Conception de maisons modernes, fonctionnelles et durables, intégrant les matériaux et le paysage du Nord-Kivu.</p></div></article>
      </div>
    </div></section>
    ...
    <section className="partnerships" id="partenariats"><div className="container partnerships-inner reveal">
      <div className="partnerships-badge"><Icon name="handshake" size={22} /><span>Partenariat & collaboration</span></div>
      <h2 className="section-title">Nous collaborons avec toute entreprise<br />qui souhaite avancer avec nous.</h2>
      <p className="section-copy">Linkstech ouvre ses partenariats à toute entreprise, startup, institution, ONG, association, bailleur ou collectivité qui souhaite collaborer sur des projets de construction, de technologie, d’ingénierie, d’énergie, de connexion aux marchés et de développement durable.</p>
      <div className="partnership-tags"><span><Icon name="building" />Entreprises</span><span><Icon name="rocket" />Startups</span><span><Icon name="users" />ONG & associations</span><span><Icon name="handshake" />Bailleurs & partenaires</span><span><Icon name="network" />Institutions & communautés</span></div>
      <div className="partnership-actions"><a className="btn btn-primary" href="#contact">Proposer un partenariat <Icon name="arrow-right" size={18} /></a><a className="btn btn-outline" href="/register.php">Rejoindre la plateforme</a></div>
    </div></section>
