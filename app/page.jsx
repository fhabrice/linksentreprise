...
export default function Home() {
  ...
  <nav className="nav" id="navbar">
    <div className="container nav-inner">
      ...
      <div className={`nav-links ${menuOpen ? 'open' : ''}`} id="navLinks" onClick={() => setMenuOpen(false)}><a href="#accueil">Accueil</a><a href="#apropos">À propos</a><a href="#services">Expertises</a><a href="#energies">Énergies</a><a href="#projets">Projets</a><a href="#partenariats">Partenariats</a><a href="/opportunities.php">Opportunités</a><a href="/blog.php">Blog</a><a href="#contact" className="btn">Être mis en relation <Icon name="arrow-up-right" size={16} /></a></div>
